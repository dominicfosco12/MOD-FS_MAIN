...
import AuthGate from "./auth/Login.jsx";
import Portfolios from "./pages/Portfolios.jsx";
import CustodyAccounts from "./pages/CustodyAccounts.jsx";
import ExecBrokerAccounts from "./pages/ExecBrokerAccounts.jsx";
import Admin from "./pages/Admin.jsx";


/**
 * MOD Galaxy 2026 — PMS/OMS/EMS Shell (with AuthGate)
 * This shell renders pages from /pages/* (Portfolios, CustodyAccounts, etc.)
 */
...
const Icon = ({ name, size = 18 }) => {
  ...
  switch (name) {
    case "rocket":
      return (
        <svg {...common}>
          <path d="M5 19l4-1 8-8 1-4-4 1-8 8-1 4z" />
          <path d="M15 9l-6 6" />
          <path d="M5 19l3-3" />
        </svg>
      );
    ...
    case "portfolio":
      return (
        <svg {...common}>
          ...
          <path d="M8 7V5a3 3 0 013-3h2a3 3 0 013 3v2" />
        </svg>
      );
    case "custody":
      return (
    ...
    case "exec":
      return (
        <svg {...common}>
          <path d="M3 12h18" />
          <path d="M7 12l-4 4V8l4 4zM21 12l-4-4v8l4-4z" />
        </svg>
      );
    case "shield":
      return (
    ...
    case "curve":
      return (
        <svg {...common}>
          <path d="M3 18c4-8 8-8 12-4s5 4 6 4" />
        </svg>
      );
    case "swap":
      return (
    ...
    <div className={`app ${sidebarCollapsed ? "app--collapsed" : ""}`}>
      ...
      <main className="main">
        ...
        <section className="content">
          ...
          {active === "custody" && <CustodyAccounts />}
          {active === "admin" && <ExecBrokerAccounts />}  // or wherever you want it
...
// --- Keep the other page stubs (we’ll replace them later one-by-one) ---
const Dashboard = () => (
  <div className="grid grid-3">
    ...
    <Card title="Workflows">
      <div className="kanban">
        <div>
          <h4>To Do</h4>
          <div className="chip">Upload Prices</div>
          <div className="chip">Review Alerts</div>
        </div>
        <div>
          <h4>In Progress</h4>
          <div className="chip">Reconcile Trades</div>
        </div>
        <div>
          <h4>Done</h4>
          <div className="chip">Create Accounts</div>
        </div>
      </div>
    </Card>
  </div>
    ...
    <div className="grid grid-2">
      ...
      <Card title="Identifiers">
        <Table
          ...
          rows={[]}
          emptyHint="instrument_identifiers…"
        />
      </Card>
    </div>
  </>
    ...
    <div className="grid grid-2">
      ...
      <Card title="Rules">
        <Table
          ...
          rows={[]}
          emptyHint="firm_compliance_rules…"
        />
      </Card>
    </div>
  </>
...
const CurvesFxBench = () => (
  <>
    ...
    <div className="grid grid-3">
      ...
      <Card title="Curves">
        <Table
          columns={["Benchmark", "Curve Date", "Method", "Source"]}
          rows={[]}
          emptyHint="curves…"
        />
      </Card>
      <Card title="FX Pairs">
        <Table
          columns={["Base", "Quote", "Settlement", "Precision"]}
          rows={[]}
          emptyHint="fx_pairs…"
        />
      </Card>
  ...
  <>
    ...
    <div className="grid grid-2">
      <Card title="Templates">
        <Table
          columns={["Name", "Underlying", "Start", "End", "BDC", "Funding Index"]}
          rows={[]}
          emptyHint="swap_templates…"
        />
      </Card>
      <Card title="Instances">
        <Table
          columns={["Trade Date", "Effective", "Maturity", "Status"]}
          rows={[]}
          emptyHint="swap_instances…"
        />
      </Card>
    </div>
  </>
...
const CSS = `
:root{--bg:#050813;--bg-2:#0a1022;--glass:rgba(255,255,255,0.06);--card:rgba(255,255,255,0.08);--border:rgba(255,255,255,0.12);--text:#e7f7ff;--muted:#9dd6e4;--neon:#72f6ff;--neon-2:#7a7bff;--accent:#9d79ff;--success:#2be6a3;--warning:#ffd359;--danger:#ff6b88}
*{box-sizing:border-box} html,body,#root{height:100%}
body{margin:0;background:radial-gradient(1200px 700px at 70% -10%, #0f1f4b, transparent), radial-gradient(800px 400px at -10% 100%, #0c193a, transparent), var(--bg); color:var(--text); font-family: ui-sans-serif, system-ui, -apple-system, Segoe UI, Inter}
